...
export const ALL_ORDERS_REQUEST="ORDERS_DETAILS_REQUEST";
export const ALL_ORDERS_SUCCESS="ORDERS_DETAILS_SUCCESS";
export const ALL_ORDERS_FAIL="ORDERS_DETAILS_FAIL";
